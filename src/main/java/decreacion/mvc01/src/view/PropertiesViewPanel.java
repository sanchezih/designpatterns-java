package decreacion.mvc01.src.view;
...
import decreacion.mvc01.src.controller.DefaultController;
import decreacion.mvc01.src.utilities.JFontChooserDialog;

/**
 * This is a custom view panel that display properties for both the document and
...
public class PropertiesViewPanel extends AbstractViewPanel {
	 ...
	 * 
	 * @param controller An object implenting the controller interface that this
	 *                   view can use to process GUI actions
	 */
	...
	/**
	 * Called by the controller when it needs to pass along a property change from a
	 * model. Note that the method checks each GUI parameter to determine if the
	 * current value is already equal to the incoming value. If it is, the method
	 * will not reset the value. This is done to prevent looping from occurring when
	 * a model property is reset.
	 * 
	...
	private void initComponents() {
		...
		documentTabPanelLayout.setHorizontalGroup(documentTabPanelLayout
				...
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, documentTabPanelLayout.createSequentialGroup()
						...
						.addGroup(documentTabPanelLayout
						...
						.addContainerGap()));
		documentTabPanelLayout.setVerticalGroup(documentTabPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(documentTabPanelLayout.createSequentialGroup().addContainerGap()
		...
		textElementTabPanelLayout.setHorizontalGroup(textElementTabPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(textElementTabPanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(textElementTabPanelLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(textScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 381,
										Short.MAX_VALUE)
								.addGroup(textElementTabPanelLayout.createSequentialGroup()
										.addGroup(textElementTabPanelLayout
												...
												.addComponent(opacityLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 74,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addComponent(rotationLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 74,
														Short.MAX_VALUE)
												.addComponent(fontLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 74,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addComponent(xPositionLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 74,
														Short.MAX_VALUE)
												.addComponent(yPositionLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 74,
														Short.MAX_VALUE))
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addGroup(textElementTabPanelLayout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
														textElementTabPanelLayout.createSequentialGroup()
																.addComponent(font,
																		javax.swing.GroupLayout.DEFAULT_SIZE, 226,
																		Short.MAX_VALUE)
																.addPreferredGap(
																		javax.swing.LayoutStyle.ComponentPlacement.RELATED)
																.addComponent(changeFontButton).addPreferredGap(
																		javax.swing.LayoutStyle.ComponentPlacement.RELATED))
												...
												.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
														textElementTabPanelLayout.createSequentialGroup()
																.addGroup(textElementTabPanelLayout.createParallelGroup(
																		javax.swing.GroupLayout.Alignment.TRAILING)
																		.addComponent(opacitySlider,
																				javax.swing.GroupLayout.DEFAULT_SIZE,
																				245, Short.MAX_VALUE)
																		.addComponent(rotationSlider,
																				javax.swing.GroupLayout.DEFAULT_SIZE,
																				245, Short.MAX_VALUE))
																.addPreferredGap(
																		javax.swing.LayoutStyle.ComponentPlacement.RELATED)
		...
		textElementTabPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
				new java.awt.Component[] { opacitySpinner, rotationSpinner });

		textElementTabPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] { fontLabel,
				opacityLabel, rotationLabel, textLabel, xPositionLabel, yPositionLabel });

		textElementTabPanelLayout.setVerticalGroup(textElementTabPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(textElementTabPanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(textElementTabPanelLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(xPositionTextField, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(xPositionLabel))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(textElementTabPanelLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(yPositionTextField, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(yPositionLabel))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(textElementTabPanelLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
								.addComponent(rotationLabel, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(rotationSpinner).addComponent(rotationSlider,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(textElementTabPanelLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
								.addComponent(opacityLabel, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(opacitySpinner).addComponent(opacitySlider,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(textElementTabPanelLayout
								...
								.addComponent(font, javax.swing.GroupLayout.PREFERRED_SIZE, 21,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(fontLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 22,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(textLabel)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
	...
	private void heightTextFieldFocusLost(java.awt.event.FocusEvent evt) {// GEN-FIRST:event_heightTextFieldFocusLost
		...
		try {
			controller.changeDocumentHeight(Integer.parseInt(heightTextField.getText()));
		} catch (Exception e) {
			// Handle exception
		}
	...
	private void widthTextFieldFocusLost(java.awt.event.FocusEvent evt) {// GEN-FIRST:event_widthTextFieldFocusLost
		...
		try {
			controller.changeDocumentWidth(Integer.parseInt(widthTextField.getText()));
		} catch (Exception e) {
			// Handle exception
		}
	...
	private void yPositionTextFieldFocusLost(java.awt.event.FocusEvent evt) {// GEN-FIRST:event_yPositionTextFieldFocusLost
		...
		try {
			controller.changeElementYPosition(Integer.parseInt(yPositionTextField.getText()));
		} catch (Exception e) {
			// Handle exception
		}
	...
	private void xPositionTextFieldFocusLost(java.awt.event.FocusEvent evt) {// GEN-FIRST:event_xPositionTextFieldFocusLost
		...
		try {
			controller.changeElementXPosition(Integer.parseInt(xPositionTextField.getText()));
		} catch (Exception e) {
			// Handle exception
		}
