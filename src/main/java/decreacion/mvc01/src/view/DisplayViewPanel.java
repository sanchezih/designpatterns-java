...
public class DisplayViewPanel extends AbstractViewPanel {
	...
	private void initComponents() {
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addContainerGap().addComponent(documentNameLabel)
	...
	public void modelPropertyChange(PropertyChangeEvent evt) {
		...
		if (evt.getPropertyName().equals(DefaultController.DOCUMENT_NAME_PROPERTY)) {
			...
			Dimension newSize = new Dimension((Integer) evt.getNewValue(), displayPanel.getHeight());
			...
			Dimension newSize = new Dimension(displayPanel.getWidth(), (Integer) evt.getNewValue());
	...
	private class TextElementComponent extends JComponent {
		...
		public void paintComponent(Graphics g) {
			...
			AlphaComposite composite = AlphaComposite.getInstance(AlphaComposite.SRC_OVER, (float) (opacity / 100.0));
			...
			TextLayout textLayout = new TextLayout(text, attributes, g2.getFontRenderContext());
