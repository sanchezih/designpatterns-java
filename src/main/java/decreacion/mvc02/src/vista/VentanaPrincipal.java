package decreacion.mvc02.src.vista;
...
import decreacion.mvc02.src.controlador.Coordinador;
...
public class VentanaPrincipal extends JFrame implements ActionListener {
	...
	public VentanaPrincipal() {
		...
		textoIntroduccion = "Esta aplicacion presenta un ejemplo practico del patron " + "de disenio MVC.\n\n"
